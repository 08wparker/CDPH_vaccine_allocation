...
Code is available [here](https://github.com/08wparker/CDPH_vaccine_allocation.git). I plan to convert this page into a refreshable shiny app that can be used to generate maps for other cities.
